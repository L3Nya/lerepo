...
inherit xdg cmake python-any-r1 git-r3 optfeature flag-o-matic

DESCRIPTION="Experimental fork of Telegram Desktop"
HOMEPAGE="https://kotatogram.github.io/"

MY_P="kotatogram-desktop-${PV}"
EGIT_REPO_URI="https://github.com/kotatogram/kotatogram-desktop.git"
EGIT_COMMIT="k${PV}"
S="${WORKDIR}/${MY_P}"
